...
def parse_config():
    ...
    parser.add_argument("--save_model", type=str, default="Saved_Models/en_bert_fish.pt", help="Directory to save model")
...
loss, acc, f1 = train_fish(train_loader_list, args.num_labels, meta_lr=args.meta_lr, num_epochs=args.num_epochs)

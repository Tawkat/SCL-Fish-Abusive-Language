...
def parse_config():
    ...
    parser.add_argument("--save_model", type=str, default="Saved_Models/en_bert_erm.pt", help="Directory to save model")
...
ERM(erm_train_loader, num_labels = args.num_labels, num_epochs = args.num_epochs, pretrain_iters=100)

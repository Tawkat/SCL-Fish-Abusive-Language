...
domain_list = ['wiki', 'fb_yt', 'twitter']
...
for domain in domain_list:
  ...
  print(len(df_train['binary_labels']))
  print(len(df_train[df_train['binary_labels']==0]), len(df_train[df_train['binary_labels']==1]))

  train_examples = read_examples(df_train)


  train_features.append(convert_examples_to_features(train_examples,tokenizer,max_length=max_length,padding='max_length',truncation=True,))
...
with open(project_path+'Pickles/Domain/pickle_train_en_ERM_yt_twi_wiki.pickle', 'wb') as f:
